...
const WoodenWork = ({ isLoggedIn, userRole, addToCart, triggerLogin }) => {
  ...
  const loadProducts = async () => {
    ...
    setProducts(all.filter(p => p.category === 'woodenwork'));
  };
  ...
  return (
    <div className="category-page-wrapper">
      <BannerImage category="woodenwork" />
