...
const PoojaCupboard = ({ isLoggedIn, userRole, addToCart, triggerLogin }) => {
  ...
  const loadProducts = async () => {
    ...
    setProducts(all.filter(p => p.category === 'poojacupboard'));
  };
  ...
  return (
    <div className="category-page-wrapper">
      <BannerImage category="poojacupboard" />
