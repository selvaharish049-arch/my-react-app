...
const AdminPanel = ({ isLoggedIn, userRole }) => {
  ...
  const loadProducts = async () => {
    ...
    const custom = all.filter(item => String(item.id).startsWith('custom-'));
            ...
            <div className="form-row-2">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <optgroup label="Home Decor (Our Craftsmanship)">
                    <option value="explore-sofa">Sofa</option>
                    <option value="explore-bed">Bed</option>
                    <option value="explore-dining">Dining</option>
                    <option value="explore-tvunit">TV Unit</option>
                    <option value="explore-coffeetable">Coffee Table</option>
                    <option value="explore-mattress">Mattress</option>
                    <option value="explore-wardrobe">Wardrobe</option>
                    <option value="explore-sofacumbed">Sofa Cum Bed</option>
                    <option value="explore-bookshelf">Bookshelf</option>
                    <option value="explore-study">Study</option>
                  </optgroup>
                </select>
              </div>
            </div>
