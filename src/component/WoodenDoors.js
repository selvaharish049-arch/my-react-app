...
const WoodenDoors = ({ isLoggedIn, userRole, addToCart, triggerLogin }) => {
  ...
  const loadProducts = async () => {
    ...
    setProducts(all.filter(p => p.category === 'woodendoors'));
  };
  ...
  return (
    <div className="category-page-wrapper">
      <BannerImage category="woodendoors" />
