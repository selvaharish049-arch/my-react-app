...
const BedroomCupboard = ({ isLoggedIn, userRole, addToCart, triggerLogin }) => {
  ...
  const loadProducts = async () => {
    ...
    setProducts(all.filter(p => p.category === 'bedroomcupboard'));
  };
  ...
  return (
    <div className="category-page-wrapper">
      <BannerImage category="bedroomcupboard" />
...
export default BedroomCupboard;
